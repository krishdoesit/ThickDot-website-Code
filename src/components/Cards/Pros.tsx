...
const Pros = ({ name, description, image }: { name: string; description: string; image: string }) => {
    return (
        <div className="flex h-fit w-[350px] flex-col gap-5 rounded-3xl bg-gradient-to-t from-white to-slate-50 p-8 drop-shadow-xl transition-all duration-300 hover:-translate-y-4 hover:drop-shadow-2xl">
