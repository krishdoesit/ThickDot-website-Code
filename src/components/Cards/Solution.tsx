...
const Solution = ({ title, description, icon }: SolutionProps) => {
    return (
        <>
            <Card className="group relative h-fit gap-3 rounded-2xl border-2 border-gray-200 bg-white p-4 shadow-none backdrop-blur-sm transition-transform duration-300">
